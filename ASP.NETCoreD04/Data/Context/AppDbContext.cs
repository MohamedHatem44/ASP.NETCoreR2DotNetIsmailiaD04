using ASP.NETCoreD04.Data.Configuration;
using ASP.NETCoreD04.Data.Models;
using Microsoft.EntityFrameworkCore;

namespace ASP.NETCoreD04.Data.Context
{
    public class AppDbContext : DbContext
    {
        ...
        {
            string connectionString = "Server=MOHAMED-HATEM\\SQLEXPRESS;DataBase=ASPCoreDay04;Trusted_Connection=true;TrustServerCertificate=true";
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var departments = new List<Department>()
            {
                ...
                new Department {  Id = 4, Name = "Network" },
            };
