...
namespace ASP.NETCoreD04.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        public IActionResult CreateV02(EmployeeCreateVM employeeCreateVM)
        {
            ...
            //var isExist = db.Employees.Any(e => e.Email == employeeCreateVM.Email);
            //if (isExist)
            //{
            ...
            //// Custom Validation
            //ModelState.AddModelError("Name", "Custom Error From Server");
        ...
        {
            bool isExist = db.Employees.Any(e => e.Email == email);
            if (isExist)
            {
